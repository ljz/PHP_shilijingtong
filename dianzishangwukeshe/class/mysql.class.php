...
//		echo $this->_sql;
		...
		if (!$this->_result){
			...
			$this->_error = mysql_error($this->_conn)." over<br>";
	...
	*/
	...
	//	$fmtsql = "INSERT INTO $table ('id','email','password','nickname','truename','sex','telphone','mobile','address','admin' ) VALUES ( NULL,'".$object["email"]."','".$object["password"]."','".$object["nickname"]."','".$object["truename"]."','".$object["sex"]."','".$object["telphone"]."','".$object["mobile"]."','".$object["address"]."','".$object["admin"]."' ) ";
